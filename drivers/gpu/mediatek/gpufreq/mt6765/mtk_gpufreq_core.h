...
#define SEG3_GPU_DVFS_FREQ1			(730000)	/* KHz */
...
#define SEG3_GPU_DVFS_VSRAM0			(97500)		/* mV x 100 */
#define SEG3_GPU_DVFS_VSRAM1			(97500)		/* mV x 100 */
#define SEG3_GPU_DVFS_VSRAM2			(97500)		/* mV x 100 */
